...
class Relay(Node):
    def __init__(self):
        ...
        self.sub = self.create_subscription(PointCloud2, IN, self.cb_lidar, 10)

        self.pub_1 = self.create_publisher(PointCloud2, OUT_2, 10)
        self.sub_1 = self.create_subscription(PointCloud2, IN_2, self.cb_oakd, 10)
